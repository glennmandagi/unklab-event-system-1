...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2019 at 10:07 AM
...
(6, 'FIK DAY', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ac tortor vitae purus faucibus ornare. Et malesuada fames ac turpis egestas sed tempus urna et. Sem viverra aliquet eget sit amet tellus cras adipiscing. Orci sagittis eu volutpat odio. Quisque egestas diam in arcu cursus euismod quis viverra nibh. Amet consectetur adipiscing elit ut aliquam purus sit amet. Urna cursus eget nunc scelerisque viverra. Ultricies mi quis hendrerit dolor magna eget est lorem ipsum. At risus viverra adipiscing at in tellus integer feugiat. At augue eget arcu dictum varius duis at.\r\n\r\nUltricies lacus sed turpis tincidunt id aliquet. Vitae tempus quam pellentesque nec nam aliquam sem et. Eget nunc scelerisque viverra mauris. Est velit egestas dui id ornare. Dictumst vestibulum rhoncus est pellentesque elit ullamcorper dignissim cras. Enim eu turpis egestas pretium aenean pharetra. Et sollicitudin ac orci phasellus egestas. Sit amet tellus cras adipiscing enim eu turpis egestas. Neque convallis a cras semper auctor. Bibendum at varius vel pharetra vel. Pharetra et ultrices neque ornare aenean euismod elementum. Sit amet massa vitae tortor condimentum. Ut enim blandit volutpat maecenas volutpat blandit aliquam etiam erat. Eu consequat ac felis donec et odio pellentesque diam. Eget arcu dictum varius duis. Aliquam sem et tortor consequat id porta nibh venenatis. Mauris in aliquam sem fringilla ut morbi tincidunt. Erat pellentesque adipiscing commodo elit at imperdiet.', '2019-10-25', '2019-10-27', 6500, 'Unklab', 500);
...
CREATE TABLE `users` (
  ...
  `student_stu_nim` char(12) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `users` (`user_id`, `user_name`, `user_pass`, `student_stu_nim`, `user_status`) VALUES
(1, 'admin', '$2y$10$r5i1hgf/WFy1XK5DGsCavupdsXMB.JMXFPV1cLMah.ubrxxwueNJ2', '', 1),
(7, 'harold', '$2y$10$aOopFU/qGfnCEipazV/AduSPRm62fBcwxSxJX42E5XU9SgIJppx0u', '105021710012', 1);
...
--
ALTER TABLE `students`
  MODIFY `stu_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=572;
