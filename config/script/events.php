...
if (isset($_GET['print'])) {
    ...
    $results = mysqli_query($conn, "SELECT * FROM registrations LEFT JOIN events on registrations.events_ev_id = events.ev_id WHERE reg_id = '$id'"); 
    $row_event = mysqli_fetch_array($results);
    // <img src="" alt="" sizes="" srcset="">
    echo("<img src='http://fik.unklab.ac.id/oprs/assets/img/LogoFIK.png' style='width:200px;'>".'<br>');
    echo("<br><hr><br>");
